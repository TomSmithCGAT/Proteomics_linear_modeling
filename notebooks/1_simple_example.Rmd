...
\begin{shaded}
Question: How would you describe an experimental design such as this?
\end{shaded}
\colorlet{shadecolor}{lightgray!10} 
...
\colorlet{shadecolor}{blue!10} 
\begin{shaded}
Task: Modify the code so that the plot to show the change between Control and Treated for each mouse. How would you interpret this?
\end{shaded}
\colorlet{shadecolor}{lightgray!10} 
...
\colorlet{shadecolor}{blue!10} 
\begin{shaded}
Question: How would you interpret the summary above
\end{shaded}
\colorlet{shadecolor}{lightgray!10} 
...
\colorlet{shadecolor}{blue!10} 
\begin{shaded}
Question: Why do we only have one coefficient for the mouse ID, even though there are 5 different mice? Is this what we want?
\end{shaded}
\colorlet{shadecolor}{lightgray!10} 
...
\colorlet{shadecolor}{blue!10} 
\begin{shaded}
Question: Are we interested in the coefficients and p-values for the mouse variables?
\end{shaded}
\colorlet{shadecolor}{lightgray!10} 
...
\colorlet{shadecolor}{yellow!10} 
\begin{shaded}
Question: How would you interpret the intentisy values for this protein
\end{shaded}
...
1. What do the other coefficients represent and are we interested in the estimates and p-values?

2. Note that the intercept term is described as "conditionTreated:typeTotal".
...
\colorlet{shadecolor}{blue!10} 
\begin{shaded}
Task: By inspecting the model matrix, identify which samples are modelled by the intercept only. Does the intercept value make sense considering the intensity values for these samples?
\end{shaded}
\colorlet{shadecolor}{lightgray!10} 
