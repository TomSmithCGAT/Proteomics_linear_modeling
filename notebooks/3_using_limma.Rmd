...
\begin{shaded}
Questions:
- Why do we expect a relationship between mean intensity and variance?
\end{shaded}
\colorlet{shadecolor}{lightgray!10} 
...
- Can you estimate what propotion of proteins had a significant change in abundance?

- Why does the plot look so symetrical?
\end{shaded}
\colorlet{shadecolor}{lightgray!10} 
